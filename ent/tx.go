...
func (tx *Tx) init() {
	tx.Rent591Home = NewRent591HomeClient(tx.config)
	tx.Rent591HomeDetail = NewRent591HomeDetailClient(tx.config)
	tx.Rent591HomeDetailBreadcrumb = NewRent591HomeDetailBreadcrumbClient(tx.config)
	tx.Rent591HomeDetailBrowse = NewRent591HomeDetailBrowseClient(tx.config)
	tx.Rent591HomeDetailInfo = NewRent591HomeDetailInfoClient(tx.config)
	tx.Rent591HomeDetailNavData = NewRent591HomeDetailNavDataClient(tx.config)
	tx.Rent591HomeDetailPositionRound = NewRent591HomeDetailPositionRoundClient(tx.config)
	tx.Rent591HomeDetailPositionRoundData = NewRent591HomeDetailPositionRoundDataClient(tx.config)
	tx.Rent591HomeDetailPositionRoundDataChildren = NewRent591HomeDetailPositionRoundDataChildrenClient(tx.config)
	tx.Rent591HomeDetailPublish = NewRent591HomeDetailPublishClient(tx.config)
	tx.Rent591HomeDetailShareInfo = NewRent591HomeDetailShareInfoClient(tx.config)
	tx.Rent591HomeDetailTag = NewRent591HomeDetailTagClient(tx.config)
	tx.Rent591HomeSurrounding = NewRent591HomeSurroundingClient(tx.config)
	tx.Rent591HomeTag = NewRent591HomeTagClient(tx.config)
}
...
// applies a query, for example: Rent591Home.QueryXXX(), the query will be executed
