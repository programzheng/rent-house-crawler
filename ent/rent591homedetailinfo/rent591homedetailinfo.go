...
const (
	// Label holds the string label denoting the rent591homedetailinfo type in the database.
	Label = "rent591home_detail_info"
	...
	// Table holds the table name of the rent591homedetailinfo in the database.
	Table = "rent591home_detail_infos"
	// Rent591homeDetailsTable is the table that holds the rent591home_details relation/edge. The primary key declared below.
	Rent591homeDetailsTable = "rent591home_detail_info_rent591home_details"
...
// Columns holds all SQL columns for rent591homedetailinfo fields.
var Columns = []string{
	FieldID,
	FieldName,
	FieldValue,
...
var (
	...
	Rent591homeDetailsPrimaryKey = []string{"rent591home_detail_info_id", "rent591home_detail_id"}
)
...
// OrderOption defines the ordering options for the Rent591HomeDetailInfo queries.
