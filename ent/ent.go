...
func checkColumn(table, column string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			rent591home.Table:                                rent591home.ValidColumn,
			rent591homedetail.Table:                          rent591homedetail.ValidColumn,
			rent591homedetailbreadcrumb.Table:                rent591homedetailbreadcrumb.ValidColumn,
			rent591homedetailbrowse.Table:                    rent591homedetailbrowse.ValidColumn,
			rent591homedetailinfo.Table:                      rent591homedetailinfo.ValidColumn,
			rent591homedetailnavdata.Table:                   rent591homedetailnavdata.ValidColumn,
			rent591homedetailpositionround.Table:             rent591homedetailpositionround.ValidColumn,
			rent591homedetailpositionrounddata.Table:         rent591homedetailpositionrounddata.ValidColumn,
			rent591homedetailpositionrounddatachildren.Table: rent591homedetailpositionrounddatachildren.ValidColumn,
			rent591homedetailpublish.Table:                   rent591homedetailpublish.ValidColumn,
			rent591homedetailshareinfo.Table:                 rent591homedetailshareinfo.ValidColumn,
			rent591homedetailtag.Table:                       rent591homedetailtag.ValidColumn,
			rent591homesurrounding.Table:                     rent591homesurrounding.ValidColumn,
			rent591hometag.Table:                             rent591hometag.ValidColumn,
		})
	})
